...
BlogEngine = {
    ...
    setFlag: function (iso) {
        if (iso.length > 0)
            BlogEngine.comments.flagImage.src = BlogEngineRes.webRoot + "Resources/images/blog/flags/" + iso + ".png";
        else
            BlogEngine.comments.flagImage.src = BlogEngineRes.webRoot + "Resources/images/blog/pixel.gif";
    }
	,
    ...
    showCommentPreview: function () {
        ...
        this.$('commentPreview').innerHTML = '<img src="' + BlogEngineRes.webRoot + 'Resources/images/blog/ajax-loader.gif" width="24" height="24" alt="Loading" />';
    ...
    filterByAPML: function () {
        ...
        textbox.id = 'txtapml';
        textbox.name = 'apml';
        textbox.style.background = 'url(' + BlogEngineRes.webRoot + 'Resources/images/blog/apml.png) no-repeat 2px center';
